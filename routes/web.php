...
Route::get('/home/user_task', [App\Http\Controllers\UserTaskController::class, 'index'])->name('user_task');
Route::post('/home/user_task', [App\Http\Controllers\UserTaskController::class, 'store'])->name('stores_user_task');
Route::delete('/home/user_task/delete/{id}', 'UserTaskController@delete');
Route::get('zip', [App\Http\Controllers\ZipController::class, 'index']);
Auth::routes();
...
Route::get('/home/qrevents/details/{id}', 'QrcodeController@edit');
Route::get('/home/qrevents/zip/{id}', 'QrcodeController@zip');
